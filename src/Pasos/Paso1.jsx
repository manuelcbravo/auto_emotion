...
import { Appbar, Card, Button as ButtonP, useTheme } from 'react-native-paper';
      ...
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={styles.content}>
        <ScrollView contentContainerStyle={styles.scrollView} nestedScrollEnabled={true}>
          <Card style={styles.card}>
            <Card.Title title="Información del Propietario" />
            <Card.Content>
              <InputComponent
          ...
          <Card style={styles.card}>
            <Card.Title title="Información del Vehículo" />
            <Card.Content>
              <InputComponent
                placeholder="VIN"
                value={values.vin}
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                <View style={{ flex: 1 }}>
                  <Text style={{ marginBottom: 5}}>{ loadingVersion ? 'Cargando versiones...' : 'Versión' }</Text>
                  <DropDownPicker
                        open={openVersion}
              ...
              <View style={[styles.espacio, Platform.OS === 'ios' ? {zIndex: 600} : {}]}> 
                {/* <CustomSelect
                    open={openFabricacion}
                    value={valueFabricacion}
                    items={years}
                    setOpen={setOpenFabricacion}
                    setValue={setValueFabricacion}
                    placeholder="Versión"
                  /> */}
              </View>
              <View style={[styles.espacio, Platform.OS === 'ios' ? {zIndex: 200} : {}]}> 
                <CustomSelect
                  open={openColor}
              ...
              <View style={[styles.espacio, Platform.OS === 'ios' ? {zIndex: 300} : {}]}> 
                <CustomSelect
              ...
              <View style={[styles.espacio, Platform.OS === 'ios' ? {zIndex: 400} : {}]}> 
                <CustomSelect
...
const styles = StyleSheet.create({
  ...
  space: {
    width: 20, // Ajusta el tamaño del espacio horizontal entre los selectores
  },
  loading: {
    flex: 1,
